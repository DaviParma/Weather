      ...
      <div className='w-[23.063em] h-[18.813em]  rounded-xl border border-black shadow-xl bg-white'>
        ...
        <hr className='border'/>
         <form onSubmit={handleSubmit} className='my-28 flex justify-center items-center'>
            <input onChange={(e) => setSearch(e.target.value)} value={search} className='fixed w-[303px] h-[46px] text-center border border-black text-xl rounded-lg  shadow-lg hover:border-[#60A5FA] focus:border-[#60A5FA] focus:outline-none hover:scale-110 duration-1000' type='text' placeholder='Enter city/country name'  />
         </form>    
      </div>
    </div>
